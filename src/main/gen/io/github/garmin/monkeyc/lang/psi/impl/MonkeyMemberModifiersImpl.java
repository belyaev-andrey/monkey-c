...
public class MonkeyMemberModifiersImpl extends MonkeyPsiCompositeElementImpl implements MonkeyMemberModifiers {

  public MonkeyMemberModifiersImpl(@NotNull ASTNode node) {
    super(node);
  }
